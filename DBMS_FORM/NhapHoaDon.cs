...
namespace DBMS_FORM
{
    public partial class NhapHoaDon : Form
    {
        ...
        private void btnPDF_Click(object sender, EventArgs e)
        {
            ...
            printBill.AddCell(new Phrase(inputdate.Text));
            printBill.AddCell(new Phrase("Member:"));
            printBill.AddCell(new Phrase(member));
            printBill.AddCell(new Phrase("Member ID:"));
            printBill.AddCell(new Phrase(memberidtxt.Text));
            printBill.AddCell(new Phrase("Sale Off: "));
            printBill.AddCell(new Phrase(offtxt.Text));
            printBill.AddCell(new Phrase("Quantity:"));
            printBill.AddCell(new Phrase(quantitytxt.Text));
